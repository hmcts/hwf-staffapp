  ...
  describe 'purge old hmrc checks' do
    ...
    context "Hmrc check list for last six months" do
      ...
      context 'purged' do
        ...
        it { expect(hmrc_check_2.evidence_check_id).not_to be nil }
        ...
        it { expect(hmrc_check_3.evidence_check_id).not_to be nil }
      ...
      context 'left alone' do
        ...
        it { expect(hmrc_check_1.evidence_check_id).not_to be nil }
        ...
        it { expect(hmrc_check_4.evidence_check_id).not_to be nil }

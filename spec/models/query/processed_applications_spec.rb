...
RSpec.describe Query::ProcessedApplications, type: :model do
  ...
  describe '#find' do
    ...
    let!(:application2) { create :application_full_remission, :processed_state, office: office }
    let!(:other_office_application) { create :application_full_remission, :processed_state }
    let!(:application3) { create :application_full_remission, :processed_state, office: office }

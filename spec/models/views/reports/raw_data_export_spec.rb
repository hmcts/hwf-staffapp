  ...
  describe 'cost estimations' do
    ...
    context 'full_remission' do
      it 'fills in estimated_cost based on fee and amount_to_pay' do
        ...
        row = "#{jurisdiction},SD123,300.24,0.0,300.24,income,ABC123,,false,false,10,under,None,1,true,false,full,0.0,300.24,paper"
    ...
    context 'part_remission' do
      it 'fills in estimated_cost based on fee and amount_to_pay' do
        ...
        row = "#{jurisdiction},SD123,300.0,50.0,250.0,income,ABC123,,false,false,2000,,NI number,3,true,false,part,50.0,250.0,paper"
        expect(export).to include(row)
      end
      ...
      it 'part payment outcome is "return"' do
        ...
        # binding.pry
        row = "#{jurisdiction},SD123,300.45,50.6,249.85,income,ABC123,,false,false,2000,,NI number,3,true,false,part,300.45,0.0,paper"
        expect(export).to include(row)
      end
    ...
    context 'no_remission' do
      it 'fills in estimated_cost based on fee and amount_to_pay' do
        ...
        row = "#{jurisdiction},SD123,300.34,300.34,0.0,income,ABC123,,false,false,2000,,Home Office number,3,true,false,none,300.34,0.0,paper"
        expect(export).to include(row)
      end
    end
    ...
    context 'no_remission with evidence check' do
      it 'fills in estimated_cost based on fee and amount_to_pay' do
        ...
        row = "#{jurisdiction},SD123,300.34,0.0,300.34,income,ABC123,,false,false,2000,over,NI number,3,true,false,none,300.34,0.0,paper"
        expect(export).to include(row)
      end
      ...
      context 'over_61' do
        ...
        it 'fills in estimated_cost based on fee and amount_to_pay' do
          ...
          export = data.to_csv
          jurisdiction = none_ec.detail.jurisdiction.name
          row = "#{jurisdiction},SD123,300.34,0.0,300.34,income,ABC123,,false,false,2000,over,NI number,3,true,true,none,300.34,0.0,paper"
          expect(export).to include(row)
        end
    ...
    context 'full_remission with evidence check' do
      it 'fills in estimated_cost based on fee and amount_to_pay' do
        ...
        row = "#{jurisdiction},SD123,300.0,0.0,300.0,income,ABC123,,false,false,10,,NI number,1,true,false,full,0.0,300.0,paper"
        expect(export).to include(row)
      end
    end
    ...
    context 'part_remission with evidence check' do
      it 'fills in estimated_cost based on fee and amount_to_pay' do
        ...
        row = "#{jurisdiction},SD123,300.0,50.0,250.0,income,ABC123,,false,false,2000,,NI number,3,true,false,part,100.0,200.0,paper"
        expect(export).to include(row)
      end
    end
  end

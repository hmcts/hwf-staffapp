  ...
  describe 'cost estimations' do
    ...
    context 'full_remission' do
      it 'fills in estimated_cost based on fee and amount_to_pay' do
        ...
        row = "#{jurisdiction},135864,300.24,0.0,300.24,income,Other,,ABC123,,false,false,10,under,last_month,None,1,1,0,true,No,full,0.0,300.24,paper"
    ...
    context 'part_remission' do
      it 'fills in estimated_cost based on fee and amount_to_pay' do
        ...
        row = "#{jurisdiction},135864,300.0,50.0,250.0,income,Other,,ABC123,,false,false,2000,,average,NI number,3,1,2,true,No,part,50.0,250.0,paper"
      ...
      it 'part payment outcome is "return"' do
        ...
        row = "#{jurisdiction},135864,300.45,50.6,249.85,income,Other,,ABC123,,false,false,2000,,,NI number,3,1,2,true,No,part,300.45,0.0,paper"
    ...
    context 'no_remission' do
      it 'fills in estimated_cost based on fee and amount_to_pay' do
        ...
        row = "#{jurisdiction},135864,300.34,300.34,0.0,income,Other,,ABC123,,false,false,2000,,,Home Office number,3,1,2,true,No,none,300.34,0.0,paper"
        expect(export).to include(row)
      end
    end
    ...
    context 'no_remission with evidence check' do
      it 'fills in estimated_cost based on fee and amount_to_pay' do
        ...
        row = "#{jurisdiction},135864,300.34,0.0,300.34,income,Other,,ABC123,,false,false,2000,over,,NI number,3,1,2,true,No,none,300.34,0.0,paper"
        expect(export).to include(row)
      ...
      context 'over_61' do
        ...
        it 'fills in estimated_cost based on fee and amount_to_pay' do
          ...
          export = data.to_csv
          jurisdiction = none_ec.detail.jurisdiction.name
          row = "#{jurisdiction},135864,300.34,0.0,300.34,income,Other,,ABC123,,false,false,2000,over,,NI number,3,1,2,true,Yes,none,300.34,0.0,paper"
          expect(export).to include(row)
        end
    ...
    context 'full_remission with evidence check' do
      it 'fills in estimated_cost based on fee and amount_to_pay' do
        ...
        row = "#{jurisdiction},135864,300.0,0.0,300.0,income,Other,,ABC123,,false,false,10,,,NI number,1,,,true,No,full,0.0,300.0,paper"
        expect(export).to include(row)
      end
    end
    ...
    context 'part_remission with evidence check' do
      it 'fills in estimated_cost based on fee and amount_to_pay' do
        ...
        row = "#{jurisdiction},135864,300.0,50.0,250.0,income,Other,,ABC123,,false,false,2000,,,NI number,3,1,2,true,No,part,100.0,200.0,paper"
        expect(export).to include(row)
      end
    end
  end

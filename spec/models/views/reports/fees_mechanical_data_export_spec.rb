  ...
  describe 'data returned should only include income applications for FeesMechanical office' do
    ...
    let(:part_remission_none) {
      create :application_part_remission, :processed_state, :income_type, fee: 410.35,
                                                                          office: fees_mechanical_office, decision_cost: 0, part_payment: part_payment_none, amount_to_pay: 220
    }

    let(:part_remission_return) {
      create :application_part_remission, :processed_state, :income_type, fee: 410.35,
                                                                          office: fees_mechanical_office, decision_cost: 0, part_payment: part_payment_return, amount_to_pay: 220
    }

    let(:part_remission_part) {
      create :application_part_remission, :processed_state, :income_type, fee: 410.35,
                                                                          office: fees_mechanical_office, decision_cost: 190.35, part_payment: part_payment_part, amount_to_pay: 220
    }

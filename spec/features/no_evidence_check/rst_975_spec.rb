...
RSpec.feature 'Application is not evidence checked when above saving threshold' do
  ...
  context 'Non-refund application no evidence check for 10th application' do
    ...
    scenario 'Every 10th application is not evidence check when saving threshold exceeded' do
      ...
      fill_in 'application_year_date_of_birth', with: '1950'
      ...
      expect(page).to have_no_text('Evidence of income needs to be checked for this application')

Feature: Savings and investment threshold on staff app
  ...
  Scenario: Applicant over 61 have different question after having £3000 or more in savings
    Given As a staff who is processing HwF paper application on the staff app,
    And The applicant is over 61 years old
  ...
  Scenario: Applicant under 61 have different question after having £3000 or more in savings
    Given As a staff who is processing HwF paper application on the staff app,
    And The applicant is under 61 years old
    When I exceed saving limit

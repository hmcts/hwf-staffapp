module Report
  class FeesMechanicalDataController < ReportsController
    ...
    def data_export
      @form = form
      if @form.valid?
        build_and_return_data(extract_fees_mechanical_data, 'help-with-fees-fees_mechanical-extract')
      else
        render 'reports/fees_mechanical_data'
      end
    end
    ...
    def extract_fees_mechanical_data
      Views::Reports::FeesMechanicalDataExport.new(date_from(report_params), date_to(report_params)).to_csv
    end

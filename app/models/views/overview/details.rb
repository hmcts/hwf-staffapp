module Views
  module Overview
    class Details
      ...
      delegate(:form_name, :form_type, :claim_type, :case_number, :deceased_name, :emergency_reason,
               :calculation_scheme, to: :detail)
      ...
      def form_name
        return detail.form_name if detail.instance_of?(OnlineApplication)
